...
class _ShopperPendingApprovalScreenState
  ...
  Future<void> _openTrainingQuiz() async {
    final uri = Uri.parse(TrainingLinks.shopperQuizUrl);
  ...
  Widget _buildApprovedView() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Text(
          'Welcome to the LipaCart team. Before you start, please take a short training quiz on picking fresh produce and talking to customers. It only takes about 3 minutes.',
          style: AppTextStyles.bodySmall.copyWith(
